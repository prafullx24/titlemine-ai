            ...
            with conn.cursor() as cur:
                ...
                if exists:
                    ...
                    cur.execute(update_query, (
                        instrument_type, volume_page, 
                        effective_date,document_case, execution_date, recording_date,
                        grantor, grantee, property_description, 
                     sort_sequence, file_id
                    ))
                else:
                    # Insert new record
                    insert_query = """
                    INSERT INTO public.runsheets (
                        file_id, project_id, document_case,instrument_type, volume_page, 
                        effective_date, execution_date, file_date, grantor, grantee, 
                        property_description, remarks, sort_sequence, created_at, updated_at
                    ) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, NOW(), NOW())
                    """
                    cur.execute(insert_query, (
                        file_id, project_id,document_case, instrument_type,
                        volume_page, effective_date, execution_date, recording_date,
                        grantor, grantee, property_description, sort_sequence
                    ))
